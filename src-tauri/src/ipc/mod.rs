//! Fase 8 — Servidor IPC que expone la app a la CLI `controlcode`.
//!
//! Arranca junto con la app, escucha en loopback y despacha cada request a `commands`.
//! Ver `protocol.rs` para el formato y el modelo de autorización.
...
use protocol::{handshake_path, Handshake, Request, Response, PROTOCOL_VERSION};
